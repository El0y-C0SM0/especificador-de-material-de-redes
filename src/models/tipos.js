...
class TipoAcopladorPigtailCordao {
...
export { TipoCaboUTP, TipoConector, TipoEquipamentoRack, 
    TipoComponenteRack, TipoUnidadeQuantidades, TipoMicelanea, 
    TipoPontoTelecom, TipoAcopladorPigtailCordao, TipoFibraOptica };